...
ALLOWED_HOSTS = ['tirr.com', 'www.tirr.com', 'www.tinybit.in', 'tinybit.in','mg-url.herokuapp.com']
...
DEFAULT_HOST = 'www'
DEFAULT_REDIRECT_URL = "http://www.tinybit.in" #kirr.co
PARENT_HOST = "tinybit.in"
